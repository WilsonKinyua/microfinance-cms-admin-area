...
class HomePageSlidesController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.homePageSlides.index', compact('homePageSlides'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.homePageSlides.create');
    }
    ...
    public function store(StoreHomePageSlideRequest $request)
    {
        ...
        return redirect()->route('frontend.home-page-slides.index');
    }
    ...
    public function edit(HomePageSlide $homePageSlide)
    {
        ...
        return view('frontend.homePageSlides.edit', compact('homePageSlide'));
    }
    ...
    public function show(HomePageSlide $homePageSlide)
    {
        ...
        return view('frontend.homePageSlides.show', compact('homePageSlide'));
    }
