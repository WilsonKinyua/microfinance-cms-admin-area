    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.home-page-slides.update", [$homePageSlide->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="caption">{{ trans('cruds.homePageSlide.fields.caption') }}</label>
                            <input class="form-control" type="text" name="caption" id="caption" value="{{ old('caption', $homePageSlide->caption) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $homePageSlide->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="slide_image-dropzone">
                            </div>
...
<script>
    ...
    url: '{{ route('frontend.home-page-slides.storeMedia') }}',
    maxFilesize: 8, // MB
