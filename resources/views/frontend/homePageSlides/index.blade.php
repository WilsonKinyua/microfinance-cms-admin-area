        ...
        <div class="col-md-12">
            @can('home_page_slide_create')
                <div style="margin-bottom: 10px;" class="row">
                    <div class="col-lg-12">
                        <a class="btn btn-success" href="{{ route('frontend.home-page-slides.create') }}">
                                    ...
                                    <tr data-entry-id="{{ $homePageSlide->id }}">
                                        ...
                                        <td>
                                            @can('home_page_slide_show')
                                                <a class="btn btn-xs btn-primary" href="{{ route('frontend.home-page-slides.show', $homePageSlide->id) }}">
                                                    {{ trans('global.view') }}
                                                </a>
                                            @endcan

                                            @can('home_page_slide_edit')
                                                <a class="btn btn-xs btn-info" href="{{ route('frontend.home-page-slides.edit', $homePageSlide->id) }}">
                                                    {{ trans('global.edit') }}
                                                </a>
                                            @endcan

                                            @can('home_page_slide_delete')
                                                <form action="{{ route('frontend.home-page-slides.destroy', $homePageSlide->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
...
@can('home_page_slide_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('frontend.home-page-slides.massDestroy') }}",
