    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.home-page-slides.update", [$homePageSlide->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('caption') ? 'is-invalid' : '' }}" type="text" name="caption" id="caption" value="{{ old('caption', $homePageSlide->caption) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description" required>{{ old('description', $homePageSlide->description) }}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="photo">{{ trans('cruds.homePageSlide.fields.photo') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.homePageSlide.fields.photo_helper') }}</span>
            </div>
            <div class="form-group">
